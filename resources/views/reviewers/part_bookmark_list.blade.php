			...
			<li>
				...
				<div class="reviewer-list-info">
                    ...
                    <div class="campaign-list-info-right btn-w50">
                        <a href="#" class="btn btn-check w125 mb5 delete" data-b="{{$campaign->bookmark_id}}">삭제</a>
                        <br/>
                        <a href="#popup_term" class="btn black btn-check w125 m-fl-r apply" data-b="{{$campaign->bookmark_id}}" data-c="{{$campaign->id}}">신청하기</a>
                    </div>
                </div>
            </li>
            @empty
            <li>
                리뷰어 모집중인 관심캠페인이 없습니다.
            </li>
            @endforelse
        </ul>