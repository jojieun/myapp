...
<table>
    ...
    @forelse ($banners as $banner)
        <tr>
            <form method="post" action="{{route('admin.middle_banner_modi',$banner->id)}}" enctype="multipart/form-data">
                {!! csrf_field() !!}
        ...
        @endforelse
<tr>
    <form method="post" action="{{route('admin.middle_banner_add')}}" enctype="multipart/form-data">
        {!! csrf_field() !!}
                <td>+</td>
...
<script>
    ...
    $('.del').on('click', function(e){
       e.preventDefault();
        location.href = "middle_banner_del/"+$(this).val();
    });
    //    이미지업로드바로보기
